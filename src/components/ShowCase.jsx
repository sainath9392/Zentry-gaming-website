    ...
    >
      ...
      <div className="container mx-[10px] w-full px-3 md:px-10">
        <div className="grid grid-cols-1 sm:grid-cols-2  mx-auto w-[50vw] h-[135vh] xl:h-[145vh] xl:mx-40 gap-7 mt-50">
          <div className="flex justify-between row-end-1 sm: h-[200px] w-[340px] border -ms-16 sm:-ms-18  col-span-2 sm:col-span-1 border-gray-900 rounded">
          ...
          <div className="relative col-span-2 md:col-span-1 -ms-22 -mt-2 row-end-4 sm:row-end-1 h-[379px] w-[280px] bg-[#5542FF] rounded-lg  z-10">
            <div className="flex flex-col w-[4px] items-start justify-start mt-2 ml-2">
          ...
          <div className="relative col-span-2 ms-20 md:col-span-1 row-end-2 rounded-lg h-[200px] w-full  overflow-hidden">
          ...
          <div className="relative h-60 w-60 ms-5 -mt-3 text-blue-50 row-end-5 border overflow-hidden border-gray-800 rounded-lg col-span-2 md:col-span-1">
          ...
          <div className="col-span-2 md:col-span-1 -ms-10 row-end-3 h-[380px] w-[290px] -mt-2 bg-[#5542FF] rounded-lg z-10">
            <div className="flex flex-col w-[4px] items-start justify-start mt-2 ml-2">
              <p className="font-circular-web font-medium text-black text-[10px] uppercase ml-3">
                Tresury
              </p>
          ...
          <div className="relative -mt-3 -ms-22 bg-slate-300 row-end-6 h-[200px] w-[320px] rounded-lg col-span-2 md:col-span-1">
