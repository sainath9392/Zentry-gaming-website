  ...
  return (
    ...
    >
      ...
      <div className="container mx-[10px] w-full px-3 md:px-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-12 mx-auto w-[50vw] sm:w-full h-[135dvh] xl:h-[145vh]  gap-7 sm:gap-20 mt-50">
          <div className="flex justify-between row-end-1 sm:row-span-2 sm:h-[130px] sm:w-[230px] md:h-[145px] md:w-[250px] lg:h-[200px] lg:w-[350px] h-[200px] w-[340px] border -ms-16 sm:ms-26  sm:mt-10 lg:-mt-3 md:ms-30 lg:ms-36 xl:ms-94 2xl:ms-126 col-span-2 sm:col-span-1 border-gray-800 rounded">
            <div className="flex flex-col w-[4px] items-start justify-start mt-2 ml-2">
              ...
              <AnimatedTitle
                ...
                color="flex justify-start text-7xl sm:text-5xl lg:text-6xl ani"
              />
            </div>
            <video
          ...
          <div className="relative col-span-2 sm:col-span-1  -ms-22 sm:ms-0 -mt-2 lg:-mt-25 row-end-4 sm:row-span-2 sm:h-[300px] sm:w-[220px] md:h-[350px] md:w-[250px] lg:h-[450px] lg:w-[340px] h-[379px] w-[280px] bg-[#5542FF] rounded-sm  z-10">
            <div className="flex flex-col w-[4px] items-start justify-start mt-2 ml-2">
          ...
          <div className="relative col-span-2 ms-20 sm:col-span-1 row-end-2 sm:row-span-2 rounded-sm h-[200px]  w-[200px] sm:h-[145px] sm:w-[145px] md:h-[156px] md:w-[156px] lg:h-[200px] lg:w-[200px] bg-[#EDFF66]  z-10 overflow-hidden sm:mt-2 md:mt-5 lg:mt-6 sm:ms-47 md:ms-53 lg:ms-73 xl:ms-117 2xl:ms-149">
          ...
          <div
            className="relative h-60 w-60 sm:h-[170px] sm:w-[170px] lg:h-[220px] lg:w-[220px] md: ms-5 -mt-3 sm:-ms-0 sm:mt-32 md:mt-44 lg:mt-46 
          text-blue-50 max-xs:row-end-5 sm:row-span-3 border overflow-hidden border-gray-800 rounded-lg col-span-2 sm:col-span-1"
          >
          ...
          <div className="col-span-2 sm:col-span-1 sm:row-span-1 -ms-10 sm:ms-26 md:ms-27 lg:ms-38 xl:ms-91 2xl:ms-123 row-end-3 h-[380px] w-[290px] sm:h-[350px] sm:w-[230px] md:h-[380px] md:w-[260px] lg:h-[450px] lg:w-[340px] -mt-2 md:mt-3 lg:mt-15 bg-[#5542FF] rounded-sm z-10">
            <div className="flex flex-col w-[4px] items-start justify-start mt-2 ml-2">
              <p className="font-circular-web font-medium text-black text-[10px] uppercase ml-3">
                Tresury
              </p>
            ...
            <video
              className="w-full -mt-24 h-[382px] lg:h-[390px] lg:-mt-18"
              autoPlay
              loop
              muted
              src="/videos/case3.webm"
            />
            <div className="flex justify-around items-center -mt-8 sm:-mt-14 md:-mt-6 lg:mt-3">
          ...
          <div className="relative -mt-3 -ms-22 md:ms-96 bg-slate-300 max-xs:row-end-6 sm:row-span-2 h-[200px] w-[320px] sm:h-[150px] lg:h-[200px] lg:w-[350px] sm:w-[260px] sm:ms-87 lg:ms-128 xl:ms-160 2xl:ms-192 rounded-sm sm:mt-11 md:mt-23 lg:mt-38 col-span-2 sm:col-span-1">
